...
class C2fSimAm(nn.Module):
    ...
    def __init__(self, c1: int, c2: int, n: int = 1, shortcut: bool = False, g: int = 1, e: float = 0.5):
        ...
        self.m = nn.ModuleList(BottleneckSimAM(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
...
class BottleneckSimAM(nn.Module):
    ...
    def __init__(
        ...
        """
        super().__init__()
        self.simam = SimAM()  # SimAM modülünü başlat
        c_ = int(c2 * e)  # hidden channels
...
class PSABlock(nn.Module):
    ...
    def __init__(self, c: int, attn_ratio: float = 0.5, num_heads: int = 4, shortcut: bool = True) -> None:
        ...
        """
        super().__init__()
        print(f"PSABlock INIT -> c: {c}, num_heads: {num_heads}, shortcut: {shortcut}")
...
class C2fPSA(C2f):
    ...
    def __init__(self, c1: int, c2: int, n: int = 1, e: float = 0.5):
        ...
        Args:
            ...
            e (float): Expansion ratio.
        """
        print(f"C2fPSA INIT -> c1: {c1}, c2: {c2}, n: {n}, e: {e}")
